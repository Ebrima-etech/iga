...
const variantStyles = {
  primary: 'bg-gray-900 text-white hover:bg-black active:bg-gray-800 border border-gray-900',
  ...
  success: 'bg-emerald-600 text-white hover:bg-emerald-700 active:bg-emerald-800 border border-emerald-700',
