                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <p className="text-2xl font-semibold text-gray-900 mt-1.5">
                        D {hajjPackagePrice.toLocaleString()}
                      </p>
                    </div>
                    <ProfessionalButton
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3 text-sm bg-blue-50 p-3 rounded">
                              {year.first_deposit_amount && (
                                <div>
                                  ...
                                  <p className="text-gray-900 font-medium">D {parseFloat(String(year.first_deposit_amount)).toLocaleString()}</p>
                                </div>
                              )}
                              {year.total_package_fee && (
                                <div>
                                  <p className="text-gray-500 text-xs">Package Fee</p>
                                  <p className="text-gray-900 font-medium">D {parseFloat(String(year.total_package_fee)).toLocaleString()}</p>
                                </div>
                              )}
                            </div>
                          ) : null}
